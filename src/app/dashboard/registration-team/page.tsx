...
export default function RegistrationTeamDashboard() {
  ...
  const fetchDashboardStats = async () => {
    try {
      const response = await api.get("/registration-team/dashboard/stats");
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        >
          ...
          <div className="flex gap-4 flex-wrap">
            <Link
              href="/dashboard/registration-team/registrations"
        ...
        >
          ...
          />
          <StatCard
            title="Building Checked In"
            value={stats?.overview.buildingCheckedIn || 0}
            icon="✓"
            color="green"
          />
          <StatCard
